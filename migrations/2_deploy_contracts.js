...
module.exports = async function(deployer,network, accounts) {
  ...
  await deployer.deploy(CO2CertRegistry);
  const registry = await CO2CertRegistry.deployed();

  // Setup Roles for Mockup
  ...
  await registry.grantRole(await registry.DEFAULT_ADMIN_ROLE(),'0x6A85b9f1df53037B0824A2B957787fBBAf814Ac0');
  await instance.grantRole(await instance.COMPENSATOR_ROLE(),registry.address)
